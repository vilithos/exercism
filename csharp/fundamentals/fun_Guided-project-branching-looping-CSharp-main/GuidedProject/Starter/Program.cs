    ...
    switch (menuSelection)
    {
        case "1":
            ...
            for (int i = 0; i < maxPets; i++)
            {
                ...
                {
                    Console.WriteLine(); // leere zeile zwischen jedem tier
                    for (int j = 0; j < 6; j++)
                    {
        ...
        case "2":
            ...
            if (petCount < maxPets) // ausgabe der informationen zu anzahl und freien plätzen
            {
                Console.WriteLine(
            ...
            {
                petCount += 1; // für jeden slot der frei ist wird der user gefragt und hochgezählt
